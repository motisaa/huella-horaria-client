import React, {
  ...
  import { CrearUsuarioTrabajador, LeerUsuarioTrabajador } from "../../servicios/RQTrabajadores";
...
export const TrabajadorPagina = () => {
    ...
    const handleSubmit = async (values) => {
        if (!values.trabajadorId) {
            // Si no hay un id de trabajador, intenta crear un nuevo usuario de trabajador
            await crearUsuarioTrabajador.mutateAsync(values); // Realizar la mutación asincrónica
        }
           // navega a la página de trabajadores
